                ...
                {isEditing ? (
                    <>
                        <div className="lg:pt-6 md:pt-4 pt-3 lg:pb-28 md:pb-24 pb-14">
                            <h2 className="lg:text-3xl md:text-xl text-lg text-center font-bold lg:mb-4 md:mb-3 mb-2">Edit Post Information</h2>
                            <EditForm
                                title={post?.title}
                    ...
                    <>
                        <div className="lg:pt-6 md:pt-4 pt-3 lg:pb-28 md:pb-24 pb-14">
                            <h2 className="lg:text-3xl md:text-xl text-lg text-center font-bold lg:mb-10 md:mb-8 mb-6">{post?.title}</h2>
                            <p className="lg:text-xl/loose md:text-lg/loose text-base/loose text-justify">{post?.content}</p>
